...
void RegisterMeterPointsModule(napi_env env, napi_value exports) {
    // 1. 创建 valveMap 子对象
    napi_value meterPointObj;

    // 2. 定义方法描述符 NapiGetTotalPumps
    napi_property_descriptor descriptors[] = {
        {"getNum", nullptr, GetNum, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"setNum", nullptr, SetNum, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"setPoint", nullptr, SetPoint, nullptr, nullptr, nullptr, napi_default, nullptr},
        {"getPoint", nullptr, GetPoint, nullptr, nullptr, nullptr, napi_default, nullptr},
    };
    ...
    napi_set_named_property(env, exports, "MeterPoints", meterPointObj);
}
