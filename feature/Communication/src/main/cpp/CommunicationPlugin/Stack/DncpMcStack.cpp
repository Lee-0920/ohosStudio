...
#include <stddef.h>
#include <vector>
#include "CommunicationPlugin/eCek/DNCP/Lai/LaiTcpServer.h"
...
#include "CommunicationPlugin/eCek/DNCP/App/DscpDevice.h"
#include "CommunicationPlugin/eCek/DNCP/Port/OS/DscpScheduler.h"
...
// 协议栈各层实体对象
    ...
    #include "CommunicationPlugin/eCek/DNCP/Lai/LaiUdp.h"
    static LaiUdp s_laiDown;
#elif defined _CS_USING_LAI_RS485
    #include "CommunicationPlugin/eCek/DNCP/Lai/LaiRS485Master.h"
    static LaiRS485Master  s_laiDown;
#else
    #include "CommunicationPlugin/eCek/DNCP/Lai/LaiSerial.h"
